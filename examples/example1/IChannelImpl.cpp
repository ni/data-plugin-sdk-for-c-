...
{
   // minumum = ???
   // no minimum available. Return S_FALSE for success and no value for title
   return S_FALSE;
}
...
{
   // maximum = ???
   // no maximum available. Return S_FALSE for success and no value for title
   return S_FALSE;
}
